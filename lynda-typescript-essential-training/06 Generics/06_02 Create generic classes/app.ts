...
// Better to specify the types rather than let system detects
...
// pair1 is <number, string>, T and U are set inside KeyValuePairPrinter.constructor,
// so the next KeyValuePair has to be <number, string> as well
